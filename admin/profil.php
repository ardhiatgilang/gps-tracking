<?php
/**
 * Halaman Edit Profil Admin Lapangan
 * Admin dapat mengubah foto profil dan nama
 */
 ...
 * @return array ['success' => bool, 'compressed' => bool, 'extension' => string]
 */
function compressImage($source, $destination, $maxWidth = 400, $maxHeight = 400, $quality = 80) {
    // Jika GD tidak tersedia, kembalikan false agar menggunakan fallback
    if (!isGdAvailable()) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama_lengkap)) {
        ...
        if (isset($_FILES['foto_profil']) && $_FILES['foto_profil']['error'] === UPLOAD_ERR_OK) {
            ...
            $max_size = 10 * 1024 * 1024; // 10MB (sebelum kompresi)
            ...
            if (!in_array($file_type, $allowed_types)) {
                ...
                if (isGdAvailable()) {
                    ...
                    // Jika kompresi gagal, tampilkan error detail
                    if (!$uploadSuccess && !empty($compressResult['error'])) {
                        $error = 'Gagal mengkompress foto: ' . $compressResult['error'];
                    }
                } else {
                    // GD tidak tersedia, simpan file apa adanya dengan validasi ukuran ketat
...
<head>
    ...
    <title>Edit Profil - Admin Lapangan</title>
            ...
            <div class="card">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="profile-form-section">
                        ...
                        <div class="form-group">
                            <label>Jabatan</label>
                            <input type="text" class="form-control" value="Admin Lapangan" disabled style="background: #f3f4f6;">
                        </div>
    ...
    <script>
        ...
        function capturePhoto() {
            ...
            canvas.toBlob(function(blob) {
                ...
                // Copy file to gallery input for form submission
        ...
        // Common function to handle file preview
        function handleFileSelect(file) {
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    // Add has-photo class for lightbox functionality
